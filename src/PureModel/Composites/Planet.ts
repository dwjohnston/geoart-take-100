...
export class Planet implements ITickable, IDrawMaker{
    ...
    constructor(center: AbstractPositionMaker, speed: AbstractNumberMaker, orbitSize: AbstractNumberMaker) {
        ...
        this.position = new OrbittingPositionMaker(this.center, this.orbitSize, this.speed, this.phase);

        this.planetDrawer = new PlanetDrawer(this.center, this.orbitSize, this.position);
    }; 
