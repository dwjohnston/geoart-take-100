...
import { EnforcedValueMaker, EnforcedValueType, ValueJson, ValueMakers, ValueTypes } from '../AbstractModelItem';
...
export class AbstractValueMaker<T, TValueType extends EnforcedValueType<T, ValueTypes>, TValueMaker extends EnforcedValueMaker<ValueMakers, TValueType>>  {
